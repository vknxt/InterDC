    ...
    private fun defaultMessages(locale: String): Map<String, String> {
        return when (locale) {
            "en_us" -> linkedMapOf(
                ...
                "usage" to "&fUse &b/interdc&f or &b/dc &f<create|link|link2|style|perf|health|lockchannel|webhook|remove|reload|move|lang>\n&7Examples:\n&8- &f/dc create 3 3\n&8- &f/dc link <channelId>\n&8- &f/dc style glass\n&8- &f/dc perf\n&8- &f/dc health\n&8- &f/dc lockchannel on\n&8- &f/dc lang en_us",
                ...
                "style-set" to "&a✔ Visual style changed to &f{style}&a for this guild.",
                "style-no-guild" to "&c✖ This screen has no guild associated.",
                "style-invalid" to "&c✖ Invalid style. Use &fdiscord&c, &fglass&c, &fultra&c or &fclassic&c.",
                "perf-stats" to "&b➜ Perf stats:&7 requests=&f{requests}&7 hit/miss=&f{hits}/{misses}&7 hit-rate=&f{hitRate}%&7 renders=&f{renders}&7 avg-render=&f{avgMs}ms",
                "health-stats" to "&b➜ Health:&7 status=&f{status}&7 screens=&f{screens}&7 discord=&f{discord}&7 guilds=&f{guilds}&7 db=&f{db}&7 hit-rate=&f{hitRate}%&7 queue=&f{queue}&7 flushed=&f{batches}/{events}&7 flags=&f{flags}&7 debug=&f{debug}",
            ...
            "ja_jp" -> linkedMapOf(
                ...
                "usage" to "&fUse &b/interdc&f ou &b/dc &f<create|link|link2|style|perf|health|lockchannel|webhook|remove|reload|move|lang>\n&7Exemplos:\n&8- &f/dc create 3 3\n&8- &f/dc link <channelId>\n&8- &f/dc style glass\n&8- &f/dc perf\n&8- &f/dc health\n&8- &f/dc lockchannel on\n&8- &f/dc lang pt_br",
                ...
                "style-set" to "&a✔ Estilo visual alterado para &f{style}&a nesta guild.",
                "style-no-guild" to "&c✖ Esta tela não possui guild associada.",
                "style-invalid" to "&c✖ Estilo inválido. Use &fdiscord&c, &fglass&c, &fultra&c ou &fclassic&c.",
                "perf-stats" to "&b➜ Estatísticas de performance:&7 req=&f{requests}&7 hit/miss=&f{hits}/{misses}&7 taxa-hit=&f{hitRate}%&7 renders=&f{renders}&7 média-render=&f{avgMs}ms",
                "health-stats" to "&b➜ Health:&7 status=&f{status}&7 telas=&f{screens}&7 discord=&f{discord}&7 guilds=&f{guilds}&7 db=&f{db}&7 taxa-hit=&f{hitRate}%&7 fila=&f{queue}&7 flush=&f{batches}/{events}&7 flags=&f{flags}&7 debug=&f{debug}",
